...
import { COOLDOWN_MS, SHAKE_THRESHOLD, useShakeDetection } from '../hooks/use-device-motion';
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 12 }]}>
      ...
      <View style={[styles.hero, isShaking && styles.heroActive]}>
        ...
        <Text style={styles.heroLabel}>{isShaking ? 'Shaking!' : 'Shake to detect'}</Text>
        <Text style={styles.heroHint}>
          force {force.toFixed(1)} / {SHAKE_THRESHOLD} · {shakeCount} shakes
        </Text>
      </View>

      {available === false && <Text style={styles.warning}>DeviceMotion not available.</Text>}
      ...
      >
        <View style={styles.backdrop}>
          <View style={[styles.sheet, { paddingBottom: insets.bottom + 20 }]}>
            ...
            <Text style={styles.sheetSubtitle}>{COOLDOWN_MS}ms cooldown between shakes.</Text>
            <Pressable style={styles.button} onPress={() => setSheetOpen(false)}>
