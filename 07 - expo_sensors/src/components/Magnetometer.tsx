...
export default function MagnetometerDisplay() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 12 }]}>
      ...
      <Text style={styles.subtitle}>
        Hold the phone flat. Rotate your body — the needle points north using magnetometer x and y.
      </Text>
      ...
      {available === false && <Text style={styles.warning}>Magnetometer not available.</Text>}
