  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 12 }]}>
      ...
      <Text style={styles.subtitle}>
        Rotate the phone slowly. The card tilts while you spin. When you stop, the card goes flat
        again.
      </Text>
      ...
      <View style={styles.sensorBox}>
        ...
        <Text style={styles.sensorHint}>
          Still phone → values near 0. Twist phone → z changes. Tilt forward/back → x or y change.
        </Text>
      </View>

      {available === false && <Text style={styles.warning}>Gyroscope not available.</Text>}
