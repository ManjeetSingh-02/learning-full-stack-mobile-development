...
export default function LightSensorDisplay() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top + 12 }]}>
      ...
      {Platform.OS !== 'android' && (
        <Text style={styles.warning}>Light sensor is only available on Android in Expo.</Text>
      )}
      ...
      <Text style={styles.footer}>Bar width = lux ÷ {MAX_LUX_FOR_BAR} × 100 (capped at 100%)</Text>
    </View>
  );
}
